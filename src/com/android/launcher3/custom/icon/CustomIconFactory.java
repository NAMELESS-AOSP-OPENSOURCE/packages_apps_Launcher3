 ...
 */
package com.android.launcher3.custom.icon;
...
public class CustomIconFactory extends BaseIconFactory {

    private final IconPackStore mIconPackStore;

    public CustomIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
