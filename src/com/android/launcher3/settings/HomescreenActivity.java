 ...
 */
public class HomescreenActivity extends CollapsingToolbarBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            final Fragment f = fm.getFragmentFactory().instantiate(getClassLoader(),
                    "com.android.launcher3.settings.HomescreenActivity$HomescreenSettingsFragment");
            f.setArguments(args);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
        ...
        return startPreference(getString(R.string.home_homescreen_title), args, pref.getKey());
    }
    ...
    public static class HomescreenSettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            setPreferencesFromResource(R.xml.launcher_homescreen_preferences, rootKey);
