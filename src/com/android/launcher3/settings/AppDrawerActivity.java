 ...
 */
public class AppDrawerActivity extends CollapsingToolbarBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            final Fragment f = fm.getFragmentFactory().instantiate(getClassLoader(),
                    "com.android.launcher3.settings.AppDrawerActivity$AppDrawerSettingsFragment");
            f.setArguments(args);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
        ...
        return startPreference(getString(R.string.home_drawer_title), args, pref.getKey());
    }
    ...
    public static class AppDrawerSettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            setPreferencesFromResource(R.xml.launcher_drawer_preferences, rootKey);
