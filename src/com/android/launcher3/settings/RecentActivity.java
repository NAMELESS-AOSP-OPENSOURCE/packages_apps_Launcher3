 ...
 */
public class RecentActivity extends CollapsingToolbarBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            final Fragment f = fm.getFragmentFactory().instantiate(getClassLoader(),
                    "com.android.launcher3.settings.RecentActivity$RecentSettingsFragment");
            f.setArguments(args);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
        ...
        return startPreference(getString(R.string.home_recent_title), args, pref.getKey());
    }
     ...
     */
    public static class RecentSettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            setPreferencesFromResource(R.xml.launcher_recent_preferences, rootKey);
